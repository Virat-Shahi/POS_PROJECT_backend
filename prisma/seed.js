...
const menuItemData = [
    ...
    // Breads
    { name: 'Naan', description: 'Traditional oven-baked flatbread', price: 40, imageUrl: 'https://example.com/naan.jpg', categoryId: 5 },
    { name: 'Roti', description: 'Whole wheat flatbread', price: 30, imageUrl: 'https://example.com/roti.jpg', categoryId: 5 },
    { name: 'Garlic Naan', description: 'Naan bread topped with garlic', price: 50, imageUrl: 'https://example.com/garlic-naan.jpg', categoryId: 5 },
    { name: 'Butter Naan', description: 'Naan bread brushed with butter', price: 45, imageUrl: 'https://example.com/butter-naan.jpg', categoryId: 5 },
    { name: 'Kulcha', description: 'Leavened bread with various fillings', price: 60, imageUrl: 'https://example.com/kulcha.jpg', categoryId: 5 },
    { name: 'Paratha', description: 'Layered whole wheat flatbread', price: 50, imageUrl: 'https://example.com/paratha.jpg', categoryId: 5 },
    { name: 'Bhatura', description: 'Deep-fried leavened bread', price: 40, imageUrl: 'https://example.com/bhatura.jpg', categoryId: 5 },
    { name: 'Puri', description: 'Deep-fried unleavened bread', price: 35, imageUrl: 'https://example.com/puri.jpg', categoryId: 5 },
    { name: 'Laccha Paratha', description: 'Multi-layered flaky flatbread', price: 55, imageUrl: 'https://example.com/laccha-paratha.jpg', categoryId: 5 },
    { name: 'Missi Roti', description: 'Flatbread made with gram flour and spices', price: 45, imageUrl: 'https://example.com/missi-roti.jpg', categoryId: 5 },
];
